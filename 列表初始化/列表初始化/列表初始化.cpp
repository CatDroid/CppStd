...
int main()
{
	...
	vector<int> v1v = { 0, 5, 10, 15, 20, 25 }; // 也可以这样写
	vector<int> v2{ 0, 5, 10, 15, 20, 25 };
	vector<int> v3{ 0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50 };
	vector<int> v4{ 0, 5, 10, 15, 20 };

	// 
	int* parr = new int[12]{ 0 };  // 这样已经是初始化了
	int* parr2 = new int[12];
	cout << " "<< parr[0] << " " << parr[2] << " " << parr[6] << " " << parr[10] << endl;
	cout << " "<< parr2[0]<< " " << parr2[2] << " " <<parr2[6]<< " " << parr2[10] << endl;
